...
public class PlayersOnlineMetric implements MinecraftMetric {
  private final JavaPlugin plugin;
  private ObservableDoubleGauge gauge;

  public PlayersOnlineMetric(JavaPlugin plugin) {
    this.plugin = plugin;
  }

  @Override
  public void register(Meter meter) {
    gauge = meter.gaugeBuilder("minecraft.players.online.count")
